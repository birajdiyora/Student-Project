...
class LoginCheckMiddleWare(MiddlewareMixin):
    ...
    #     else:
    #         if request.path == reverse('about') or modulename == 'django.contrib.auth.views' or request.path == reverse('user_login'): # If the path is login or has anything to do with authentication, pass
    #             pass
    #         else:
    #             return redirect(reverse('about'))
    pass
