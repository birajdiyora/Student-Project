...
def courses(request):
    ...
    return render(request, 'frontend/courses.html', {'courses': all_courses})
...
def copywriting(request):
    return render(request, 'frontend/copywriting.html')

def pricing(request):
    return render(request, 'frontend/pricing.html')

def starterpage(request):
    return render(request, 'frontend/starterpage.html')
