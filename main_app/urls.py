...
#     path('index.html/', views.index, name='index'),
    ...
    path('login/', views.login, name='ulogin'),
    path('register.html/', views.register, name='register'),
    path('webdesign.html/', views.webdesign, name='webdesign'),
    path('seo.html/', views.seo, name='seo'),
    path('copywriting.html/', views.copywriting, name='copywriting'),
